...
export default function EFTPointsReference({ className = "" }: { className?: string }) {
  return (
    ...
    >
      {/* PARTIE 1 : Repères visuels (largeur fixe, alignée à gauche) */}
      <div style={{ width: 300, boxSizing: "border-box", marginBottom: 8 }}>
        <a
      ...
      {/* PARTIE 2 : Texte bleu (centré, largeur fixe) */}
      <div style={{ maxWidth: 800, margin: "0 auto", boxSizing: "border-box" }}>
        <p style={{ color: "#2980b9", marginTop: 12, lineHeight: 1.6, textAlign: "justify", textJustify: "inter-word" as any }}>
