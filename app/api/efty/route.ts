...
if (lastAssistantAskForMedicalOverride && isExplicitNo(lastUserMsg)) {
  const reply = `D'accord, tu me dis "non", mais si tu as le moindre doute, consulte immédiatement. Ta santé est prioritaire. Peux-tu préciser où exactement tu ressens cette douleur dans ta poitrine ? (ex. centre, gauche, droite, diffuse ou localisée…)`;
  return new NextResponse(
